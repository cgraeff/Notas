...
\begin{table}[!ht]
\tbl{Parameters sets for the lagrangian density \protect\eqref{Eq:LagNJL-SU2-Bub}. (B$_i$ from \protect\refcite{Buballa1996}, B$_R$ Set 2 of \protect\refcite{Buballa2005}).}
...
\begin{table}[htb]
\tbl{Chemical potential $\mu_B^i$ at crossing point por different parameterization combinations. For B$_R$ we have transition only for $G_V = 0$.}
{\begin{tabular}{@{}ccccccccc@{}} \toprule
...
\bibitem{Cavagnoli2011} R. Cavagnoli, C. Provid{\^e}ncia, D. P. Menezes, {\it Phys. Rev. C} {\bf 83} (2011) 045201
