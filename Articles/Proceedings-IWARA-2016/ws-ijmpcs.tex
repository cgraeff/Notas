...
\begin{table}[!ht]
\tbl{Parameters sets for the lagrangian density \protect\eqref{Eq:LagNJL-SU2-Bub}. (B$_i$ from \protect\cite{Buballa1996}, B$_R$ Set 2 of \protect\cite{Buballa2005}).}
...
\input{graph/quark-hadron_phase_transition}
\end{figure}
