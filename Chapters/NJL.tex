...
Só sei que não descreve a saturação da matéria de nucleons.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Lagrangiana do modelo eNJL em SU(2)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
	\item Discutir:
		\begin{itemize}
			...
			\item Equação do Gap, auto-energia.
	...
	\item Problemas:
		\begin{itemize}
			...
			\item A adição de mais termos faz alguma diferença na equação do gap?
		\end{itemize}
\end{itemize}
