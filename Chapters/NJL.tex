...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Solução da Equação do Gap}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Calcular as equações da maneira mais simplificada possível, procurando fazer o cálculo que resulta nas integrais de $p_F$ a $\Lambda$. Começar a implementar a solução da eq. do Gap, deixar o potencial e eqs. de estado para depois.
