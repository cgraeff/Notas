...
\begin{itemize}
	\item Discutir:
		\begin{itemize}
			...
			\item Determinação a Equação do Gap (tem a ver com auto-energia). \footnote{Pode ser calculada através do potencial termodinâmico, que é o que vamos fazer.}
		...
		\end{itemize}
	\item Copiar tabela de parâmetros do Buballa;
	\item Determinar a equação do gap (acho que é $\partial \omega/\partial m = 0$;
	\item Revisar parte eNJL;
\end{itemize}
