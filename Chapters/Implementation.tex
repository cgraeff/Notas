...
\begin{itemize}
	...
	\item \textbf{Entropia: implementar nova expressão que derivei(verificar antes), implementar a expressão que peguei do artigo do James; comparar resultados. Se forem diferentes, ficar com a do James. Se forem iguais, tentar mais uma vez chegar de uma na outra.}
\end{itemize}
