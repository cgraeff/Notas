...
\begin{itemize}
	\item Implementação:
		\begin{itemize}
			...
			\item [OK] Ver a integral da eq. 2.4, deve ser de $0 \to p_F$, não de $p_F \to \Lambda$; O problema nem era aí, mas no cálculo para o vácuo.
			...
			\item Recalcular para $G_V$ não nulo;
