...
\begin{figure*}
	\input{graphics/Rep_Tsue/mass_chem_pot.tex}
	\caption{Reprodução da Fig. 2 em \textcite{japoneses2}. \protect\input{graphics/Rep_Tsue/info.tex}}
	\label{Fig:Mass_Tsue}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Tsue/barionic_dens_chemical_potential.tex}
	\caption{Reprodução da Fig. 3 em \textcite{japoneses2}. \protect\input{graphics/Rep_Tsue/info.tex}}
	\label{Fig:Dens_Tsue}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Tsue/pressure_chem_pot.tex}
	\caption{Reprodução da Fig. 4 em \textcite{japoneses2}. \protect\input{graphics/Rep_Tsue/info.tex}}
...
\begin{figure*}
	\input{graphics/Rep_Buballa_2.9/mass_chem_pot.tex}
	\caption{Reprodução da Fig. 2.9 em \textcite{Buballa}. \protect\input{graphics/Rep_Buballa_2.9/info.tex}}
	\label{Fig:Buballa_2.9_1}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Buballa_2.9/barionic_dens_chemical_potential.tex}
	\caption{Reprodução da Fig. 2.9 em \textcite{Buballa}. \protect\input{graphics/Rep_Buballa_2.9/info.tex}}
	\label{Fig:Buballa_2.9_2}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Buballa_2.9/mass_chem_pot_GV.tex}
	\caption{Reprodução da Fig. 2.9 em \textcite{Buballa}. \protect\input{graphics/Rep_Buballa_2.9/info_GV.tex}}
	\label{Fig:Buballa_2.9_3}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Buballa_2.9/barionic_dens_chemical_potential_GV.tex}
	\caption{Reprodução da Fig. 2.9 em \textcite{Buballa}. \protect\input{graphics/Rep_Buballa_2.9/info_GV.tex}}
...
\begin{figure*}
	\input{graphics/Test_entropy_integrand_calc/entropy_integrand_calc_methods_0_3_3}
...
\begin{figure*}
	\input{graphics/Test_entropy_integrand_calc/entropy_integrand_calc_methods_0_4_4}
	\caption{Gráfico comparando os métodos de cálculo do integrando da entropia $m = \np[MeV]{50}$, $\mu_R = \np[MeV]{400}$, $T = \np[MeV]{20.0}$. \protect\input{graphics/Test_entropy_integrand_calc/info.tex}}
...
\begin{figure*}
	\input{graphics/Maps/map_0_0}
	\caption{Mapa mostrando as regiões das Equações~\ref{gap} e~\ref{gap_rho} (zeradas) que estão próximas a zero (em verde e roxo, respectivamente). O ponto em preto representa uma estimativa para a raíz das equações, dada pelo ponto de interseção entre as duas regiões. $T = \np[MeV]{1.0}$, $\rho_B = \np[fm^{-3}]{0.04}$.\protect\input{graphics/Maps/info.tex}}
	\label{Fig:Map_0_0}
\end{figure*}
...
\begin{figure*}
	\input{graphics/Maps/map_6_0}
	\caption{Mapa mostrando as regiões das Equações~\ref{gap} e~\ref{gap_rho} (zeradas) que estão próximas a zero (em verde e roxo, respectivamente). O ponto em preto representa uma estimativa para a raíz das equações, dada pelo ponto de interseção entre as duas regiões. $T = \np[MeV]{25.0}$, $\rho_B = \np[fm^{-3}]{0.04}$. \protect\input{graphics/Maps/info.tex}}
	\label{Fig:Map_6_0}
\end{figure*}

\begin{figure*}
	\input{graphics/Maps/map_9_0}
	\caption{Mapa mostrando as regiões das Equações~\ref{gap} e~\ref{gap_rho} (zeradas) que estão próximas a zero (em verde e roxo, respectivamente). O ponto em preto representa uma estimativa para a raíz das equações, dada pelo ponto de interseção entre as duas regiões.  $T = \np[MeV]{50.0}$, $\rho_B = \np[fm^{-3}]{0.04}$.\protect\input{graphics/Maps/info.tex}}
	\label{Fig:Map_9_0}
\end{figure*}
...
\begin{figure*}
	\input{graphics/m_vac_eNJL/thermodynamic_potential_by_mass.tex}
...
\begin{figure*}
	\input{graphics/Rep_Pais/mass.tex}
	\caption{Reprodução da Fig. 2 em \textcite{Pais}.}
	\label{Fig:Rep_Pais_Mass}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Pais/pressure.tex}
	\caption{Reprodução da Fig. 2 em \textcite{Pais}.}
	\label{Fig:Rep_Pais_Pressure}
\end{figure*}

\begin{figure*}
	\input{graphics/Rep_Pais/energy_density_per_particle.tex}
	\caption{Reprodução da Fig. 2 em \textcite{Pais}.}
...
\begin{figure*}
	\input{graphics/beta_equil/pressure.tex}
	\caption{Pressão para o caso em que temos equilíbrio $\beta$ e neutralidade de carga. \protect\input{graphics/beta_equil/info.tex}}
	\label{Fig:Pressure_beta_equil}
\end{figure*}

\begin{figure*}
	\input{graphics/beta_equil/energy_density.tex}
	\caption{Densidade de energia para o caso em que temos equilíbrio $\beta$ e neutralidade de carga. \protect\input{graphics/beta_equil/info.tex}}
	\label{Fig:energy_density_beta_equil}
\end{figure*}

\begin{figure*}
	\input{graphics/beta_equil/energy_density_per_particle.tex}
	\caption{Densidade de energia por partícula para o caso em que temos equilíbrio $\beta$ e neutralidade de carga. \protect\input{graphics/beta_equil/info.tex}}
	\label{Fig:energy_per_particle_beta_equil}
\end{figure*}

\begin{figure*}
	\input{graphics/beta_equil/electron_chemical_potential.tex}
	\caption{Potencial químico do elétron para o caso em que temos equilíbrio $\beta$ e neutralidade de carga. \protect\input{graphics/beta_equil/info.tex}}
	\label{Fig:Electron_chemical_potential_beta_equil}
\end{figure*}

\begin{figure*}
	\input{graphics/beta_equil/proton_fraction.tex}
	\caption{Fração de prótons para o caso em que temos equilíbrio $\beta$ e neutralidade de carga. \protect\input{graphics/beta_equil/info.tex}}
...
\begin{figure*}
	\input{graphics/Binodals/Buballa_1-eNJL1-quark-hadron_phase_transition.tex}
	\caption{Binodal para \texttt{[Buballa1, eNJL1]}}
	\label{Fig:Binodal1}
\end{figure*}

\begin{figure*}
	\input{graphics/Binodals/Buballa_1-eNJL1-quark-hadron_phase_transition2.tex}
	\caption{Binodal para \texttt{[Buballa1, eNJL1]}}
	\label{Fig:Binodal2}
\end{figure*}

\begin{figure*}
	\input{graphics/Binodals/Buballa_1-eNJL1m-quark-hadron_phase_transition.tex}
	\caption{Binodal para \texttt{[Buballa1, eNJL1m]}}
	\label{Fig:Binodal3}
\end{figure*}

\begin{figure*}
	\input{graphics/Binodals/Buballa_1-eNJL1m-quark-hadron_phase_transition2.tex}
	\caption{Binodal para \texttt{[Buballa1, eNJL1m]}}
	\label{Fig:Binodal4}
\end{figure*}

\begin{figure*}
	\input{graphics/Binodals/Buballa_1-eNJL2-quark-hadron_phase_transition.tex}
	\caption{Binodal para \texttt{[Buballa1, eNJL2]}}
	\label{Fig:Binodal5}
\end{figure*}

\begin{figure*}
	\input{graphics/Binodals/Buballa_1-eNJL2-quark-hadron_phase_transition2.tex}
	\caption{Binodal para \texttt{[Buballa1, eNJL2]}}
	\label{Fig:Binodal6}
\end{figure*}
