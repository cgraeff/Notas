...
Nas Figuras~\ref{Fig:Mass_Tsue} a~\ref{Fig:Press_Tsue}, temos uma reprodução de dados similares aos contidos em \textcite{japoneses2}.
...
Obtemos os resultados das Figuras~\ref{Binodal1} a \ref{Binodal6} para as binodais, fazendo como em \textcite{japoneses2} (escolhidos aleatóriamente só para exemplificar).
